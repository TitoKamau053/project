...
<p className="text-2xl font-bold text-white">KES
     {safeToLocaleString(stats.total_active_investments).toLocaleString(undefined, {
...
<div>
<p className="text-white font-bold">
KES {earningLogs.reduce((sum, log) => sum + (log.earning_amount || 0), 0).toLocaleString(undefined, {
    minimumFractionDigits: 2,
    maximumFractionDigits: 2
  })}
</p>
...
<div className="bg-slate-800 rounded-lg p-4">
<div className="text-center">
<div className="text-2xl font-bold text-green-500">{safeNumber(stats.active_mining_engines).toLocaleString(undefined, {
    minimumFractionDigits: 2,
    maximumFractionDigits: 2
  })}</div>
...
<div className="bg-slate-800 rounded-lg p-4">
<div className="text-center">
<div className="text-2xl font-bold text-blue-500">{safeNumber(stats.active_investments).toLocaleString(undefined, {
    minimumFractionDigits: 2,
    maximumFractionDigits: 2
  })}</div>
...
<div className="bg-slate-800 rounded-lg p-4">
<div className="text-center">
<div className="text-2xl font-bold text-purple-500">KES {safeToLocaleString(stats.total_active_investments).toLocaleString(undefined, {
    minimumFractionDigits: 2,
    maximumFractionDigits: 2
  })}</div>
...
<div className="text-white bg-slate-700 px-3 py-2 rounded">{new Date(selectedUser.created_at).toLocaleString()}</div>
</div>
</div>
...
<span className="text-slate-400">{new Date(deposit.created_at).toLocaleString()}</span>
</div>
))}
</div>
</div>
...
<span className="text-slate-400">{new Date(withdrawal.created_at).toLocaleString()}</span>
</div>
))}
</div>
</div>
...
<span className="text-slate-400">{new Date(purchase.created_at).toLocaleString()}</span>
</div>
))}
</div>
</div>
